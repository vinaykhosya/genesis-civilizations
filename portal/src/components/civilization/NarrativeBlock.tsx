    ...
    <section style={{
      ...
      <div>
        ...
        <p style={{
          ...
          Can stable behavioral adaptations and resource sharing mechanisms emerge in environments constrained by high selection pressure?
        </p>
      </div>
      ...
      <div>
        ...
        <p style={{
          ...
          If resource scarcity exceeds critical thresholds (scarcity &gt; 4x), territorial disputes will rise, suppressing mutual attachment and reproduction rates, leading to early lineage extinction cascades.
        </p>
      </div>
      ...
      <div>
        ...
        <div style={{
          ...
          <span style={{ padding: "0.4rem 0.75rem", borderRadius: "var(--radius-sm)", background: "var(--bg-secondary)", border: "1px solid var(--border-default)", fontFamily: "var(--font-mono)", fontSize: "12px", color: "var(--text-primary)" }}>
