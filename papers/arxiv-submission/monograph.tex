...
\hypersetup{
  ...
  pdfkeywords={artificial life, evolutionary computation, agent-based simulation, geography, emergence}
}
...
\affil[1]{Independent Researcher \\ \href{mailto:vinayroyale123@gmail.com}{vinayroyale123@gmail.com} \quad \href{https://genesis.vinaykhosya.com}{genesis.vinaykhosya.com} \\ \href{https://orcid.org/0009-0002-5232-5432}{\texttt{ORCID: 0009-0002-5232-5432}}}
...
\textbf{Hardware-independent execution.}
All stochastic elements are controlled exclusively through the fixed integer seed passed to a deterministic PRNG\linebreak ({\texttt{numpy.random.default\_rng(1720)}}). The engine contains no wall-clock dependencies, thread-racing, or platform-specific floating-point behaviour; simulation state is therefore exactly reproducible across hardware. Execution speed is not a reproducibility variable.
...
\begin{description}[font=\bfseries]
  ...
  \item[Dataset --- Experiment 1] (Accelerated Social Bonds, seed 1720, 100,228 ticks): CSV logs, event streams, world maps, and summary statistics are permanently archived on Zenodo: \href{https://doi.org/10.5281/zenodo.21735662}{doi:10.5281/zenodo.21735662}.
  \item[Dataset --- Experiment 2] (Pilot Study / Monograph Run, seed 1720, 326,075 ticks): All primary data underlying the results reported in this paper are permanently archived on Zenodo: \href{https://doi.org/10.5281/zenodo.21735664}{doi:10.5281/zenodo.21735664}.
  \item[Preprint Archive:] This manuscript (PDF + \LaTeX{} source) is permanently archived on Zenodo: \href{https://doi.org/10.5281/zenodo.21735672}{doi:10.5281/zenodo.21735672}.
  \item[Replay Viewer:] Client-side Canvas2D replay streams enabling tick-level spatial inspection are accessible at \url{https://genesis.vinaykhosya.com/archive}.
