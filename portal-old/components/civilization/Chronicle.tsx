                ...
                {ch.prose.map((p, idy) => (
                  <div key={idy} style={{
                    ...
                    <div style={{
                      ...
                      background: p.eventType === "Birth" ? "var(--event-birth)" : p.eventType === "Death" ? "var(--event-death)" : "var(--accent-400)",
                      boxShadow: p.eventType === "Birth" ? "var(--event-birth-shadow)" : p.eventType === "Death" ? "var(--event-death-shadow)" : "none"
                    }} />
